...
from app.domains.matters.dashboard_service import DashboardService
...
async def dashboard_summary(user: Auth):
    """Aggregated dashboard data for the current user (role-aware)."""
    db = get_db()
